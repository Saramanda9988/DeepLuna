 ...
 */
public interface MessageTransportClient<T> {
    /**
     * 创建连接
     ...
     */
    void sendMessage(T connection, ChatResp streamChatResponse);
     ...
     * @param streamChatResponse 消息内容
     */
    void sendEndMessage(T connection, ChatResp streamChatResponse);
